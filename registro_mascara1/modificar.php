		...
		<div class="container">
			...
			<form class="form-horizontal" method="POST" action="update.php" autocomplete="off">
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<input type="email" class="form-control" id="cargo" name="email" placeholder="Email" value="<?php echo $row['correo']; ?>"  required>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<input type="tel" class="form-control" id="usuario" name="telefono" placeholder="Telefono" value="<?php echo $row['telefono']; ?>" >
					</div>
				</div>
				...
				<div class="form-group">
					<div class="col-sm-offset-2 col-sm-10">
						<a href="../registro_mascara1/registro_mascara1.php" class="btn btn-default">Regresar</a>
