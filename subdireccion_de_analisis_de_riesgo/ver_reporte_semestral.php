        ...
        <ul>
          <li id="liestadistica3" class="subtitle3">
            ...
            <ul class="submenu3">
              ...
              <!-- <li id="limedidas" class="menu-items"><a href="../subdireccion_de_analisis_de_riesgo/total_medidas.php">&nbsp;&nbsp;&nbsp;<i class='color-icon fa-solid fa-person-circle-plus  menu-nav--icon fa-fw'></i><span class="menu-items" style="color: white;"> MEDIDAS</span></a></li> -->
            </ul>
          </li>
        </ul>
      </nav>
