...
// $consulta = "SELECT * FROM tickets WHERE folio_expediente = '$fol_exp' ";
// $result_consul = mysqli_query($mysqli, $consulta);
// $res = mysqli_fetch_array($result_consul);
// $id = $res['id'];
// $usuario = $res['usuario'];
// echo $usuario;
    ...
    <?php if (isset ($_SESSION ['message'])){?>
      ...
      <div class="wrap">
        ...
        <ul class="tabs">
          ...
          <li><a href="#" class="active" onclick="location.href='tickets.php?folio=<?php echo $fol_exp; ?>'"><span class="fas fa-book-open"></span><span class="tab-text">INCIDENCIAS GENERADAS</span></a></li>
...
<a href="../subdireccion_de_analisis_de_riesgo/create_ticket.php?folio=<?php echo $fol_exp; ?>" class="btn-flotante">REGRESAR</a>
