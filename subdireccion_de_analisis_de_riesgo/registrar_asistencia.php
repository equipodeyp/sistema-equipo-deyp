      ...
      <div class="wrap">
        ...
        <div class="secciones">
          ...
          <div class="secciones form-horizontal sticky breadcrumb flat">
            ...
            <a class="actived" href="./registrar_asistencia.php">REGISTRAR ASISTENCIA PSICOLÓGICA</a>
          </div>
            ...
            <div class=" well form-horizontal">
              ...
              <ul class="tabs">
                <li><a href="#" class="active" onclick="location.href='registrar_asistencia.php'"><span class="far fa-regular fa-bell"></span><span class="tab-text">REGISTRAR ASISTENCIA</span></a></li>
