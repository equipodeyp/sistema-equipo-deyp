...
<div class="modal fade" id="edit_<?php echo $fget3dyas['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            ...
            <form method="POST">
              <div class="modal-body">
                   ...
                   <div class="row">
                     ...
                     <div class="col-md-6 mb-3 validar">
                       <label for="RESUELTO">¿HA SIDO RESUELTO?<span ></span></label>
                       <input class="form-control" id="DIAS_RESTANTES" name="DIAS_RESTANTES" placeholder="" type="text" disabled value="<?php echo $fget3dyas['estatus']; ?>" maxlength="50">
                     </div>
                   </div>
                   <br>
                   <div class="row">
