      ...
      <nav class="menu-nav">
          ...
          <ul>
				   <?php
		   				if ($user=='guillermogv') {
							echo "
								<a style='text-align:center' class='user-nombre' href='/SIPPSIPPED v2/sistema-equipo-deyp/subdireccion_de_analisis_de_riesgo/solicitar_asistencia.php'><button type='button' class='btn btn-light'>REGISTRAR ASISTENCIA <br> MÉDICA</button> </a>
							";
						  }
					?>
          </ul>
