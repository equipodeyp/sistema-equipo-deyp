...
<div class="contenedor">
  ...
  <div class="main bg-light">
    <div class="barra">
      ...
      <div class="wrap">
        <ul class="tabs">
    		<li><a href="#" class="active" onclick="location.href='./detalle_incidencia_asistencia.php?folio_incidencia=<?php echo $folio_incidencia; ?>'"><span class="far fa-address-card"></span><span class="tab-text">DETALLE DE LA INCIDENCIA</span></a></li>
        </ul>
            ...
            <div class="container">
              ...
              <form class="container well form-horizontal" enctype="multipart/form-data">
                  ...
                  <div class="col-md-12 mb-6">
                    ...
                    <input readonly class="form-control" id="" name="" placeholder="" type="text" value="<?php echo $respuesta1['descripcion_falla']; ?>">
                  </div>
<!--
                  <div class="col-md-6 mb-3">
