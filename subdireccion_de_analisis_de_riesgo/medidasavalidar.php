                  ...
                  $contador = 0;
                        ...
                        $rq = $mysqli->query($query);
                           while($row = $rq->fetch_assoc()){
                             ...
                             $id_medida = $row['id'];
                             $fecha_inicio=$row['date_definitva'];
                             $dper = "SELECT * FROM datospersonales WHERE id = '$id_per'";
                             $rdper = $mysqli->query($dper);
                             $fdper = $rdper->fetch_assoc();

                             $devaluacion = "SELECT * FROM evaluacion_persona WHERE fecha_inicio = '$fecha_inicio'";
                             $rdevaluacion = $mysqli->query($devaluacion);
                             while ($fdevaluacion = $rdevaluacion->fetch_assoc()) {
                                $fdevaluacion['id_convenio'];
                               // code...
                             }


                             $med = "SELECT * FROM multidisciplinario_medidas WHERE id_medida = '$id_medida'";
                             $rmed = $mysqli->query($med);
                             $fmed = $rmed->fetch_assoc();
                                 ?>

                                     <tr>
                                        <td style="text-align:center"><?php echo $contador ?></span></td>
                                        <td style="text-align:center"><?php echo $row['id']; ?></span></td>
                                        <td style="text-align:center"><?php echo $fdper['identificador']; ?></span></td>
                                        <td style="text-align:center"><?php echo $fdper['folioexpediente']; ?></span></td>
                                        ...
                                        <td style="text-align:center"><?php echo $fmed['acuerdo']; ?></span></td>
                                        <td style="text-align:center">
                                          <form method="POST" action="validar_medida.php?folio=<?php echo $row['id_medida']; ?>">
