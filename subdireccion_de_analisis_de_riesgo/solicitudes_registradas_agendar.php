        ...
        <div class="secciones">
          <article id="tab1">
            ...
            <div class=" well form-horizontal">
              ...
              <ul class="tabs">
                <li><a href="#" class="active" onclick="location.href='./solicitudes_registradas_agendar.php'"><span class="fas fa-regular fa-clipboard"></span><span class="tab-text">SOLICITUDES DE ASISTENCIA MÉDICA MEDIDAS PROVISIONALES</span></a></li>
