...
$id_pers = $_SESSION['folio_expediente_id'];
// echo $id_pers;
$fol = $_SESSION['folio_expediente'];
// echo $fol;
$iniciales = $_SESSION['idpersona'];
// echo $iniciales;
  ...
  <div class="main bg-light">
    <div class="barra">
      ...
      <ul class="tabs">
          ...
          <li><a href="#" class="active" onclick="location.href='ver_pdf_persona.php?folio=<?php echo $fol; ?>'"><span class="fa-solid fa-eye"></span><span class="tab-text">VISTA PREVIA</span></a></li>
          ...
          <li><a href="#" onclick="location.href='resumen_tickets_canceladas.php'"><span class="far fa-address-card"></span><span class="tab-text">CANCELADAS</span></a></li> -->
    		...
    		<div class="secciones">
              ...
              <div class="secciones form-horizontal sticky breadcrumb flat">
                        ...
                        <a href="detalles_expediente.php?folio=<?=$fol?>">EXPEDIENTE</a>
              ...
              <!-- <form class="container well form-horizontal" method="POST" action="cargar_archivo.php?folio=<?php echo $id_person; ?>" enctype="multipart/form-data""> -->
                <div class="row">
                  ...
                  <?php
                          $path  = "../subdireccion_de_analisis_de_riesgo/repo/$resultado/$iniciales";
                          ...
                          foreach($files as $file){
                            ...
                            if ($name_doc === $arg) {
                              ...
                              echo "<iframe style='width:990px; height:600px; border: none;' src='../subdireccion_de_analisis_de_riesgo/repo/$resultado/$iniciales/$arg#toolbar=0&navpanes=0&scrollbar=0&embedded=true&navpanes=0' id='iframe_id' onload='disableContextMenu();' onMyLoad='disableContextMenu();'>"; echo "</iframe>";
                              echo '</div>';
                              break;
                            }
                          }
