      ...
      <div class="wrap">
        ...
        <div class="secciones">
          ...
          <div class="secciones form-horizontal sticky breadcrumb flat">
            ...
            <a href="./asistencia_turnada.php">ASISTENCIAS PSICOLÓGICAS TURNADAS</a>
          ...
          <!-- <div class="secciones form-horizontal sticky breadcrumb flat">
            ...
            <div class=" well form-horizontal">
              ...
              <ul class="tabs">
                <li><a class="active" href="#" onclick="location.href='./registrar_seguimiento.php?id_asistencia_medica=<?php echo $id_asistencia_medica; ?>'"><span class="far fa-regular fa-address-card"></span><span class="tab-text">REGISTRAR SEGUIMIENTO</span></a></li>
        ...
        <div id=division_1>
                  ...
                  <!-- <div class="form-group">
                    <label for="cita_seguimiento" class="col-md-4 control-label">REQUIERE SEGUIMIENTO</label>
                    <div class="col-md-4">
                      <div class="input-group">
