...
$select2 = "SELECT datospersonales.identificador, datospersonales.estatusprograma, estatus
FROM datospersonales
WHERE datospersonales.folioexpediente = '$folio' AND datospersonales.estatus = 'PERSONA PROPUESTA'
