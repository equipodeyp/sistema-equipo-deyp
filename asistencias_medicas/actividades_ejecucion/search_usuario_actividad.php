...
if ($actividad === '2') {
  $atender = "SELECT COUNT(*) AS suma FROM react_actividad
                 WHERE id_subdireccion = 4 AND usuario = '$usuario' AND id_actividad = 2 AND (fecha BETWEEN '$fecha_inicio' AND '$fecha_fin')";
...
$totalactividades = "SELECT COUNT(*) AS suma FROM react_actividad
WHERE id_subdireccion = 4 AND usuario = '$usuario' AND id_actividad = 3 AND (fecha BETWEEN '$fecha_inicio' AND '$fecha_fin')";
$rtotalactividades = $mysqli->query($totalactividades);
$ftotalactividades = $rtotalactividades ->fetch_assoc();
$html .='<tfoot>
          <tr>
...
while ($fimplementarname = $rimplementarname ->fetch_assoc()){
  ...
  $accion = "SELECT COUNT(*) AS suma FROM react_actividad
                 WHERE id_subdireccion = 4 AND usuario = '$usuario' AND id_actividad = 4 AND clasificacion = '$varaccion' AND (fecha BETWEEN '$fecha_inicio' AND '$fecha_fin')";
...
$totalactividades = "SELECT COUNT(*) AS suma FROM react_actividad
WHERE id_subdireccion = 4 AND usuario = '$usuario' AND id_actividad = 4 AND (fecha BETWEEN '$fecha_inicio' AND '$fecha_fin')";
$rtotalactividades = $mysqli->query($totalactividades);
$ftotalactividades = $rtotalactividades ->fetch_assoc();
$html .='<tfoot>
          <tr>
...
while ($fsalvaguardarname = $rsalvaguardarname ->fetch_assoc()) {
  ...
  $salvaguardar = "SELECT COUNT(*) AS suma FROM react_actividad
                 WHERE id_subdireccion = 4 AND usuario = '$usuario' AND id_actividad = 5 AND clasificacion = '$varsalvaguardar' AND (fecha BETWEEN '$fecha_inicio' AND '$fecha_fin')";
...
$totalactividades = "SELECT COUNT(*) AS suma FROM react_actividad
WHERE id_subdireccion = 4 AND usuario = '$usuario' AND id_actividad = 5 AND (fecha BETWEEN '$fecha_inicio' AND '$fecha_fin')";
$rtotalactividades = $mysqli->query($totalactividades);
$ftotalactividades = $rtotalactividades ->fetch_assoc();
$html .='<tfoot>
          <tr>
...
elseif ($actividad === '6') {
  $recorridos = "SELECT COUNT(*) AS suma FROM react_actividad
                 WHERE id_subdireccion = 4 AND usuario = '$usuario' AND id_actividad = 6 AND (fecha BETWEEN '$fecha_inicio' AND '$fecha_fin')";
...
$html .='</table>
        ...
        $fnombreact = $rnombreact->fetch_assoc();
                $html .='<table width="100%" style="border-spacing: 0;" bgcolor="#5F6D6B" align="left">
