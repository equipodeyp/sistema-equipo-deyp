...
while ($fimplementarname = $rimplementarname ->fetch_assoc()){
  ...
  $accion = "SELECT COUNT(*) AS suma FROM react_actividad
                 WHERE id_subdireccion = 4 AND usuario = '$name' AND id_actividad = 4 AND clasificacion = '$varaccion' AND (fecha BETWEEN '$fecha_inicio' AND '$fecha_fin')";
...
$totalactividades = "SELECT COUNT(*) AS suma FROM react_actividad
WHERE id_subdireccion = 4 AND usuario = '$name' AND id_actividad = 4 AND (fecha BETWEEN '$fecha_inicio' AND '$fecha_fin')";
$rtotalactividades = $mysqli->query($totalactividades);
$ftotalactividades = $rtotalactividades ->fetch_assoc();
$html .='<tfoot>
          <tr>
...
while ($fsalvaguardarname = $rsalvaguardarname ->fetch_assoc()) {
  ...
  $salvaguardar = "SELECT COUNT(*) AS suma FROM react_actividad
                 WHERE id_subdireccion = 4 AND usuario = '$name' AND id_actividad = 5 AND clasificacion = '$varsalvaguardar' AND (fecha BETWEEN '$fecha_inicio' AND '$fecha_fin')";
...
$totalactividades = "SELECT COUNT(*) AS suma FROM react_actividad
WHERE id_subdireccion = 4 AND usuario = '$name' AND id_actividad = 5 AND (fecha BETWEEN '$fecha_inicio' AND '$fecha_fin')";
$rtotalactividades = $mysqli->query($totalactividades);
$ftotalactividades = $rtotalactividades ->fetch_assoc();
$html .='<tfoot>
          <tr>
