...
while ($fimplementarname = $rimplementarname ->fetch_assoc()){
  ...
  $accion = "SELECT COUNT(*) AS suma FROM react_actividad
                 WHERE id_subdireccion = 4 AND id_actividad = 4 AND usuario = '$name' AND clasificacion = '$varaccion' AND (fecha BETWEEN '$fecha_inicio' AND '$fecha_fin')";
...
$html .='<td width="50%" style="border: 1px solid black; padding: 2px; text-align: center;">'.$cont2.'-'.$fimplementarname['nombre'].'</td>
         <td width="5%" style="border: 1px solid black; padding: 2px; text-align: center;"> ACCIÓN </td>
...
while ($fsalvaguardarname = $rsalvaguardarname ->fetch_assoc()) {
  ...
  $salvaguardar = "SELECT COUNT(*) AS suma FROM react_actividad
                 WHERE id_subdireccion = 4 AND id_actividad = 5 AND usuario = '$name' AND clasificacion = '$varsalvaguardar' AND (fecha BETWEEN '$fecha_inicio' AND '$fecha_fin')";
