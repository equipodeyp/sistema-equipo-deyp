...
$atender = "SELECT COUNT(*) AS suma FROM react_actividad
               WHERE id_subdireccion = 4 AND id_actividad = 2 AND usuario = '$name' AND usuario = '$name' AND (fecha BETWEEN '$fecha_inicio' AND '$fecha_fin')";
...
while ($ffacilitarname = $rfacilitarname ->fetch_assoc()) {
  ...
  $faccontact = "SELECT COUNT(*) AS suma FROM react_actividad
                 WHERE id_subdireccion = 4 AND id_actividad = 3 AND usuario = '$name' AND clasificacion = '$varclasif' AND (fecha BETWEEN '$fecha_inicio' AND '$fecha_fin')";
...
$recorridos = "SELECT COUNT(*) AS suma FROM react_actividad
               WHERE id_subdireccion = 4 AND id_actividad = 6 AND usuario = '$name' AND (fecha BETWEEN '$fecha_inicio' AND '$fecha_fin')";
...
$html .='<tr>
         ...
         $actividadessujetos = "SELECT COUNT(*) AS suma FROM react_actividad
                        WHERE id_subdireccion = 4 AND id_actividad = 7 AND usuario = '$name' AND (fecha BETWEEN '$fecha_inicio' AND '$fecha_fin')";
         ...
         $html .='<tr>
                  ...
                  $otrasactividades = "SELECT COUNT(*) AS suma FROM react_actividad
                                 WHERE id_subdireccion = 4 AND id_actividad = 8 AND usuario = '$name' AND (fecha BETWEEN '$fecha_inicio' AND '$fecha_fin')";
...
$totalactividades = "SELECT COUNT(*) AS suma FROM react_actividad
               WHERE id_subdireccion = 4 AND usuario = '$name' AND (fecha BETWEEN '$fecha_inicio' AND '$fecha_fin')";
