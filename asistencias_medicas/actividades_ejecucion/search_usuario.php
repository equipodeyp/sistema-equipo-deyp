...
$html .='<tr>
         ...
         $actividadessujetos = "SELECT COUNT(*) AS suma FROM react_actividad
                        WHERE id_subdireccion = 4 AND id_actividad = 7 AND usuario = '$usuario' AND (fecha BETWEEN '$fecha_inicio' AND '$fecha_fin')";
         ...
         $html .='<tr>
                  ...
                  $actividadessujetos = "SELECT COUNT(*) AS suma FROM react_actividad
                                 WHERE id_subdireccion = 4 AND id_actividad = 8 AND usuario = '$usuario' AND (fecha BETWEEN '$fecha_inicio' AND '$fecha_fin')";
                  $ractividadessujetos = $mysqli->query($actividadessujetos);
                  $factividadessujetos = $ractividadessujetos ->fetch_assoc();
                  $html .='<tr>
