        ...
        <div class="secciones">
          <article id="tab1">
            ...
            <div class="secciones form-horizontal sticky breadcrumb flat">
              ...
              <a class="actived" href="./solicitud_registrada.php">SOLICITUDES REGISTRADAS</a>
            </div>
            ...
            <div class=" well form-horizontal">
              ...
              <ul class="tabs">
                    ...
                    <li><a href="#" class="active" onclick="location.href='./solicitud_registrada.php'"><span class="fas fa-regular fa-clipboard"></span><span class="tab-text">SOLICITUDES REGISTRADAS</span></a></li>
...
$sentencia=" SELECT * FROM usuarios WHERE usuario='$m_user'";
$result = $mysqli->query($sentencia);
$row=$result->fetch_assoc();
$genero = $row['sexo'];
$id_user = $row['id'];
...
// echo $permiso3;
              ...
              $cl = "SELECT COUNT(*) as t FROM solicitud_asistencia WHERE etapa = 'SOLICITADA' AND id_servidor= '$id_servidor_ini'";
              $rcl = $mysqli->query($cl);
              $fcl = $rcl->fetch_assoc();
              // echo $fcl['t'];
              if ($fcl['t'] == 0){
                      ...
                      <div class='row'>
                        <div id='cabecera'>
                          <div class='row alert div-title'>
                            <h3 style='text-align:center'>SOLICITUDES REGISTRADAS POR EL USUARIO: $id_servidor_ini</h3>
                          </div>
                        </div>
                      <div>
...
<tbody>
                                                <?php
                                                    ...
                                                    $query = "SELECT * FROM solicitud_asistencia WHERE id_servidor = '$id_servidor_ini' AND etapa = 'SOLICITADA' ORDER BY solicitud_asistencia.fecha_solicitud ASC";
