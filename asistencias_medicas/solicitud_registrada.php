...
// echo $permiso3;
              ...
              $cl = "SELECT COUNT(*) as t FROM solicitud_asistencia WHERE etapa = 'SOLICITADA' AND id_servidor= '$m_user'";
              $rcl = $mysqli->query($cl);
              $fcl = $rcl->fetch_assoc();
              // echo $fcl['t'];
              if ($fcl['t'] == 0){
                      ...
                      <div class='row'>
                        <div id='cabecera'>
                          <div class='row alert div-title'>
                            <h3 style='text-align:center'>SOLICITUDES REGISTRADAS POR EL USUARIO: $m_user</h3>
                          </div>
                        </div>
                      <div>
