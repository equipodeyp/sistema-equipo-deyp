...
<div class="contenedor">
  ...
  <div class="main bg-light">
          ...
          <article class="">
            <div class=" well form-horizontal">
              <div class="secciones form-horizontal sticky breadcrumb flat">
                ...
                <a href="detalles_expediente.php?folio=<?php echo $fol_exp; ?>">EXPEDIENTE</a>
                <a class="actived">REGISTRO PERSONA</a>
              </div>
              <strong><span><label >* CAMPOS OBLIGATORIOS</label> </span></strong>
              <form id="myform" method="POST" action="guardar_sujeto.php?folio=<?php echo $fol_exp; ?>" enctype= "multipart/form-data">
                ...
                <div class="row">
                  ...
                  <div class="col-md-6 mb-3 validar">
                    ...
                    <input onkeyup="validarfrm()" class="verific form-control" id="FECHA_SOLICITUD" name="FECHA_SOLICITUD" type="date" value="<?php echo $filacheckautoridad['fechasolicitud']; ?>" required min="<?php echo $datemin; ?>">
                  </div>
                ...
                <div class="" style="display:none;" id="persona_p">
                  <div class="alert div-title">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6 mb-3 validar">
                      <!-- <br> -->
                      <br>
                      <button class="color-btn-success" onclick="enviarId()" disabled="true" style="display: block; margin: 0 auto; justify-content: center;" id="GENERAR_ID" type="button"> GENERAR ID </button>
                    </div>
                    <div class="col-md-6 mb-3 validar">
                ...
                <div class="" style="display:none;" id="procesopenal">
                  <div class="alert div-title">
                ...
                <div class="" style="display:none;" id="valoracionjuridica">
                  <div class="alert div-title">
                ...
                <div class="" style="display:none;" id="expedientes_relacionales">
                  <div class="alert div-title">
                ...
                <div class="" style="display:none;" id="persona_reingreso">
                  <div class="alert div-title">
                ...
                <!-- <div class="" style="display:none;" id="fotografia">
                  <div class="alert div-title">
                ...
                <div class="" style="display:none;" id="comentarios">
                  <div class="alert div-title">
                    <h3 style="text-align:center">COMENTARIOS</h3>
                  </div>
                  <textarea style="resize: none;" name="COMENTARIO" id="COMENTARIO" rows="8" cols="210" placeholder="Escribe tu comentario" maxlength="1000"></textarea>
                  <div class="row">
                  </div>
                </div>
    ...
    <div class="contenedor">
      <a href="detalles_expediente.php?folio=<?php echo $fol_exp; ?>" class="btn-flotante">CANCELAR</a>
    </div>
  </div>
