    ...
    <?php if (isset ($_SESSION ['message'])){?>
      ...
      <div class="wrap">
        ...
        <ul class="tabs">
          ...
          <li><a href="#" class="active" onclick="location.href='repo_estadistica.php'"><span class="fa-solid fa-square-poll-horizontal"></span><span class="tab-text">ESTADISTICA</span></a></li>
                    ...
                    <table class="table table-bordered" id="table-tickets">
                        ...
                        <p>  
                            ...
                            <tr>
                              ...
                              <td style="text-align:center"><a title="Descargar Archivo" href="../subdireccion_de_estadistica_y_preregistro/archivos_subidos_estadistica/<?php echo $archivos[$i]; ?>" download="<?php echo $archivos[$i]; ?>" style="color: blue; font-size:18px;"> <span class="glyphicon glyphicon-download-alt" aria-hidden="true"></span> </a></td>
                              <td style="text-align:center"><a title="Eliminar Archivo" href="eliminar_archivo.php?name=../subdireccion_de_estadistica_y_preregistro/archivos_subidos_estadistica/<?php echo $archivos[$i]; ?>" style="color: red; font-size:18px;" onclick="return confirm('Esta seguro de eliminar el archivo?');"> <span class="glyphicon glyphicon-trash" aria-hidden="true"></span> </a></td>
                            </tr>
                        <?php }?> 
                        </tbody>
                    </table>
