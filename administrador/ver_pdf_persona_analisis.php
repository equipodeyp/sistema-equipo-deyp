...
$id = $_SESSION['folio_persona'];
$iniciales = $_SESSION['iniciales'];
$folio_expediente = $_SESSION['folio_expediente'];
  ...
  <div class="main bg-light">
    <div class="barra">
      ...
      <ul class="tabs">
          ...
          <li><a href="#" class="active" onclick="location.href='ver_pdf_persona_analisis.php?folio=<?=$fol_exp?>'"><span class="fa-solid fa-eye"></span><span class="tab-text">VISTA PREVIA</span></a></li>
