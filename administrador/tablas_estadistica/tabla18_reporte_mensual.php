...
//
echo "<tr >";
echo "<td style='border: 5px solid #97897D; text-align:left'>"; echo 'MEDIDAS DE ASISTENCIA'; echo "</td>";
echo "<td style='border: 5px solid #97897D; text-align:center'>"; echo $fenejeca['t']; echo "</td>";
echo "<td style='border: 5px solid #97897D; text-align:center'>"; echo $fejeca['t']; echo "</td>";
echo "<td style='border: 5px solid #97897D; text-align:center'>"; echo $fcancela['t']; echo "</td>";
echo "<td style='border: 5px solid #97897D; text-align:center'>"; echo $fasist['t']; echo "</td>";
echo "</tr>";
//
echo "<tr >";
echo "<td style='border: 5px solid #97897D; text-align:left'>"; echo 'MEDIDAS DE RESGUARDO'; echo "</td>";
echo "<td style='border: 5px solid #97897D; text-align:center'>"; echo $fenejecr['t']; echo "</td>";
echo "<td style='border: 5px solid #97897D; text-align:center'>"; echo $fejecr['t']; echo "</td>";
echo "<td style='border: 5px solid #97897D; text-align:center'>"; echo $fcancelr['t']; echo "</td>";
echo "<td style='border: 5px solid #97897D; text-align:center'>"; echo $fresg['t']; echo "</td>";
echo "</tr>";
//
echo "<tr bgcolor=''>";
echo "<td style='border: 5px solid #97897D; text-align:right'>"; echo "<b>"; echo 'TOTAL DE MEDIDAS DE APOYO'; echo "</b>"; echo "</td>";
echo "<td style='border: 5px solid #97897D; text-align:center'>"; echo "<b>"; echo $feneject['t']; echo "</b>"; echo "</td>";
echo "<td style='border: 5px solid #97897D; text-align:center'>"; echo "<b>"; echo $feject['t']; echo "</b>"; echo "</td>";
echo "<td style='border: 5px solid #97897D; text-align:center'>"; echo "<b>"; echo $fcanceltot['t']; echo "</b>"; echo "</td>";
echo "<td style='border: 5px solid #97897D; text-align:center'>"; echo "<b>"; echo $fmedidast['t']; echo "</b>"; echo "</td>";
echo "</tr>";
?>
