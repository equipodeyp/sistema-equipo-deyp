...
while ($fselecpersnorel2 = $rselecpersnorel2->fetch_assoc()){
  ...
  while ($fid_permed = $rid_permed->fetch_assoc()) {
    ...
    //////////////////////////////////////////////////////////////////////////////
    echo "<tr>";
    echo "<td style='text-align:center; border: 1px solid black;'>"; echo $cont2; echo "</td>";
    echo "<td style='text-align:center; border: 1px solid black;'>"; echo $fselecpersnorel2['folioexpediente']; echo "</td>";
    echo "<td style='text-align:center; border: 1px solid black;'>"; echo date("d/m/Y", strtotime($fexped['fecha_nueva'])); echo "</td>";
    echo "<td style='text-align:center; border: 1px solid black;'>"; echo $fselecpersnorel2['identificador']; echo "</td>";
    echo "<td style='text-align:center; border: 1px solid black;'>"; echo $fselecpersnorel2['calidadpersona']; echo "</td>";
    echo "<td style='text-align:center; border: 1px solid black;'>"; echo $fselecpersnorel2['estatus']; echo "</td>";
    echo "<td style='text-align:center; border: 1px solid black;'>"; echo $fselecpersnorel2['sexopersona']; echo "</td>";
    echo "<td style='text-align:center; border: 1px solid black;'>"; echo $fselecpersnorel2['edadpersona']; echo "</td>";
    echo "<td style='text-align:center; border: 1px solid black;'>"; echo $fselecpersnorel2['grupoedad']; echo "</td>";
    echo "<td style='text-align:center; border: 1px solid black;'>"; echo $fdetinc['convenio']; echo "</td>";
    echo "<td style='text-align:center; border: 1px solid black;'>"; if ($fdetinc['fecha_inicio'] !== '0000-00-00') {
      echo date("d/m/Y", strtotime($fdetinc['fecha_inicio']));
    }  echo "</td>";
    echo "<td style='text-align:center; border: 1px solid black;'>"; echo $fsuj2021['t']; echo "</td>";
    echo "<td style='text-align:center; border: 1px solid black;'>"; echo $fsuj2022['t']; echo "</td>";
    echo "<td style='text-align:center; border: 1px solid black;'>"; echo $fsuj2023['t']; echo "</td>";
    ////////////////////////////////////////////////////////////////////////////////////////////
    echo "<td style='text-align:center; border: 1px solid black;'>"; if ($ftmedinicial['date_provisional'] === '0000-00-00') {
      echo date("d/m/Y", strtotime($ftmedinicial['date_definitva']));
    }else {
      echo date("d/m/Y", strtotime($ftmedinicial['date_provisional']));
    } echo "</td>";
    ///////////////////////////////////////////////////////////////////////////////////////////////
    echo "<td style='text-align:center; border: 1px solid black;'>"; if ($ftmedinfinal['date_ejecucion'] === '0000-00-00') {
      echo 'EN EJECUCION';
    }else {
    ...
    if ($ftmedinfinal['date_ejecucion'] === '0000-00-00') {
     ...
     echo "</td>";
     ////////////////////////////////////////////////////////////////////////////////////////////
    echo "<td style='text-align:center; border: 1px solid black;'>"; echo $ftmedinfinal['estatus']; echo "</td>";
    echo "<td style='text-align:center; border: 1px solid black;'>"; echo $fselecpersnorel2['relacional']; echo "</td>";
    echo "<td style='text-align:center; border: 1px solid black;'>"; echo $fselecpersnorel2['reingreso']; echo "</td>";
    echo "<td style='text-align:center; border: 1px solid black;'>"; echo $fselecpersnorel2['estatusprograma']; echo "</td>";
    echo "<td style='text-align:center; border: 1px solid black;'>"; echo $fautoridadsol['nombreautoridad']; echo "</td>";
    echo "<td style='text-align:center; border: 1px solid black;'>"; if ($fdetincsujinc['delitoprincipal'] === 'OTRO') {
      echo $fdetincsujinc['otrodelitoprincipal'];
    }else {
      echo $fdetincsujinc['delitoprincipal'];
    } echo "</td>";
    echo "<td style='text-align:center; border: 1px solid black;'>"; if ($fselecpersnorel2['estatus'] === 'PERSONA PROPUESTA') {
      echo "EN ELABORACION";
