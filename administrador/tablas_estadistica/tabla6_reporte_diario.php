...
//
echo "<tr >";
echo "<td style='text-align:left; border: 3px solid black;'>"; echo 'ASISTENCIA'; echo "</td>";
...
//
echo "<tr >";
echo "<td style='text-align:left; border: 3px solid black;'>"; echo 'RESGUARDO'; echo "</td>";
...
//
echo "<tr bgcolor=''>";
echo "<td style='text-align:right; border: 3px solid black;'>"; echo "<b>"; echo 'TOTAL DE MEDIDAS DE APOYO'; echo "</b>"; echo "</td>";
