          ...
          while ($falotem2 = $ralotem2->fetch_assoc()) {
            ...
            if ($name === $name2 && $primerapell === $primerapell2 && $segundoapell === $segundoapell2) {
              ...
              echo "<tr bgcolor=";
                echo 'greenyellow';
               echo ">";
                  echo "<td style='text-align:center'>"; echo $numconsec; echo "</td>";
                  echo "<td style='text-align:center'>"; echo $folsujeto; echo "</td>";
                  echo "<td style='text-align:center'>"; echo $fexpedientesuj['fecha_nueva']; echo "</td>";
                  echo "<td style='text-align:center'>"; echo $fselecpersnorel['identificador']; echo "</td>";
                  echo "<td style='text-align:center'>"; echo $fselecpersnorel2['estatus']; echo "</td>";
                  echo "<td style='text-align:center'>"; echo $fselecpersnorel['sexopersona']; echo "</td>";
                  echo "<td style='text-align:center'>"; echo $fselecpersnorel['edadpersona']; echo "</td>";
                  echo "<td style='text-align:center'>"; echo $fselecpersnorel['grupoedad']; echo "</td>";
                  ...
                  $alotem31 = "SELECT * FROM medidas
                  WHERE medida = 'VIII. ALOJAMIENTO TEMPORAL' AND id_persona = '$idsujeto2'";
                  $ralotem31 = $mysqli->query($alotem31);
                  $falotem31 = $ralotem31->fetch_assoc();
                  if ($falotem31['date_ejecucion'] === '0000-00-00') {
                    echo "en ejecucion";
                  }else {
                    echo $falotem31['date_ejecucion'];
                  }
                  echo "</td>";
                  echo "<td style='text-align:center'>"; if ($falotem3['date_provisional'] === '0000-00-00') {
                  ...
                  if ($falotem31['date_ejecucion'] === '0000-00-00') {
                    ...
                    $date22 = $falotem31['date_ejecucion'];
                  }
                  ...
                  echo "<td style='text-align:center'>"; echo $falotem31['estatus']; echo "</td>";
              echo "</tr>";
              ...
              echo "<tr bgcolor="; if($falotem4['estatus'] === 'CANCELADA'){
                ...
                echo "<td style='text-align:center'>"; echo $fexpedientesuj['fecha_nueva']; echo "</td>";
                echo "<td style='text-align:center'>"; echo $fselecpersnorel['identificador'];; echo "</td>";
                echo "<td style='text-align:center'>"; echo $fselecpersnorel['estatus']; echo "</td>";
                echo "<td style='text-align:center'>"; echo $fselecpersnorel['sexopersona']; echo "</td>";
                echo "<td style='text-align:center'>"; echo $fselecpersnorel['edadpersona']; echo "</td>";
                echo "<td style='text-align:center'>"; echo $fselecpersnorel['grupoedad']; echo "</td>";
                echo "<td style='text-align:center'>"; echo $fconveniosuj['convenio']; echo "</td>";
                ...
                if ($falotem4['date_ejecucion'] === '0000-00-00') {
                 ...
                 echo $interval->days . " dias";echo "</td>";
