...
WHERE medida = 'VIII. ALOJAMIENTO TEMPORAL' AND estatus != 'CANCELADA'";
...
while ($falotem = $ralotem->fetch_assoc()) {
  ...
  //   $fechaincio = $falotem3['date_definitva'];
  // }else {
  //   $fechaincio = $falotem3['date_provisional'];
  // }
  // $fechafinal = $falotem4['date_ejecucion'];
  // $intvl = $fechaincio->diff($fechafinal);
  ...
  while ($falotem2 = $ralotem2->fetch_assoc()) {
    echo "<tr>";
      echo "<td style='text-align:left'>"; echo $falotem2['folioexpediente']; echo "</td>";
