...
INNER JOIN determinacionincorporacion ON datospersonales.id = determinacionincorporacion.id_persona
WHERE datospersonales.estatus = 'SUJETO PROTEGIDO' AND determinacionincorporacion.date_convenio BETWEEN '2023-01-01' AND '2023-01-31'";
...
INNER JOIN determinacionincorporacion ON datospersonales.id = determinacionincorporacion.id_persona
WHERE datospersonales.estatus = 'SUJETO PROTEGIDO' AND determinacionincorporacion.date_convenio BETWEEN '2023-03-01' AND '2023-03-31'";
...
INNER JOIN determinacionincorporacion ON datospersonales.id = determinacionincorporacion.id_persona
WHERE datospersonales.estatus = 'SUJETO PROTEGIDO' AND determinacionincorporacion.date_convenio BETWEEN '2023-04-01' AND '2023-04-30'";
...
//
$tcalidadtotal2023 = "SELECT COUNT(*) AS t FROM datospersonales
INNER JOIN determinacionincorporacion ON datospersonales.id = determinacionincorporacion.id_persona
WHERE datospersonales.relacional = 'NO' AND datospersonales.estatus = 'SUJETO PROTEGIDO' AND determinacionincorporacion.date_convenio BETWEEN '2023-01-01' AND '2023-12-31'";
$restcalidadtotal2023 = $mysqli->query($tcalidadtotal2023);
$filatcalidadtotal2023 = $restcalidadtotal2023->fetch_assoc();
//
...
while ($fila = $res->fetch_assoc()) {
    ...
    INNER JOIN determinacionincorporacion ON datospersonales.id = determinacionincorporacion.id_persona
    WHERE datospersonales.calidadpersona = '$r' AND datospersonales.estatus = 'SUJETO PROTEGIDO' AND determinacionincorporacion.date_convenio BETWEEN '2023-01-01' AND '2023-01-31'";
    ...
    INNER JOIN determinacionincorporacion ON datospersonales.id = determinacionincorporacion.id_persona
    WHERE datospersonales.calidadpersona = '$r' AND datospersonales.estatus = 'SUJETO PROTEGIDO' AND determinacionincorporacion.date_convenio BETWEEN '2023-03-01' AND '2023-03-31'";
    ...
    //
    $ttotalcalidad2023 = "SELECT COUNT(*) AS t FROM datospersonales
    INNER JOIN determinacionincorporacion ON datospersonales.id = determinacionincorporacion.id_persona
    WHERE datospersonales.relacional = 'NO' AND datospersonales.calidadpersona = '$r' AND datospersonales.estatus = 'SUJETO PROTEGIDO' AND determinacionincorporacion.date_convenio BETWEEN '2023-01-01' AND '2023-12-31'";
    $resttotalcalidad2023 = $mysqli->query($ttotalcalidad2023);
    $filattotalcalidad2023 = $resttotalcalidad2023->fetch_assoc();
    //
    ...
    //
    $t2022 = "SELECT COUNT(*) AS t2022 FROM datospersonales
    INNER JOIN determinacionincorporacion ON datospersonales.id = determinacionincorporacion.id_persona
    WHERE datospersonales.calidadpersona = '$r' AND datospersonales.estatus = 'SUJETO PROTEGIDO' AND determinacionincorporacion.date_convenio BETWEEN '2022-01-01' AND '2022-12-31'";
    $rest2022 = $mysqli->query($t2022);
    $fila_t2022 = $rest2022->fetch_assoc();
    //
    if ($t2021) {
      while ($fila_t2021=mysqli_fetch_assoc($rest2021)) {
        ...
        echo "<td style='text-align:center'>"; echo $filattotalcalidad2023['t']; echo "</td>";
...
echo "<td style='text-align:center'>"; echo $filatcalidadtotal2023['t']; echo "</td>";
