<?php
$consecutivo = 0;
$expedientes2022 = "SELECT * FROM expediente WHERE fecha_nueva BETWEEN '2022-01-01' AND '2022-12-31'";
$rexpedientes2022 = $mysqli->query($expedientes2022);
while ($fexpedientes2022 = $rexpedientes2022->fetch_assoc()) {
  $consecutivo = $consecutivo + 1;
  $folioexpediente = $fexpedientes2022['fol_exp'];
  //////////////////////////////////////////////////////////////////////////////
  ...
  echo "<td style='border: 5px solid #97897D; text-align:center'>"; echo $fexpedientes2022['fol_exp']; "</td>";
  echo "<td style='border: 5px solid #97897D; text-align:center'>"; echo $fautoridad['nombreautoridad'];"</td>";
  echo "<td style='border: 5px solid #97897D; text-align:center'>"; echo $fexpedientes2022['fecharecep']; "</td>";
