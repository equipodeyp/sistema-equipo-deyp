    ...
    <div class="main bg-light">
      ...
      <div class="container">
        <div class="row">
          ...
          <br><br>
          <h1 style="text-align:center"> CONSULTAR METAS CONVENIOS </h4>
          <br><br>
      ...
      <div class="">
        ...
        ?>
            ...
            if ($mostrar === 1) {
              $conexion=mysqli_connect("localhost","root","","sistemafgjem");
              $SQL="SELECT react_actividad.id_subdireccion, react_actividad.fecha, react_actividad.folio_expediente, react_actividad.id_sujeto, react_actividad.id_evidencia
                    ...
                    $where
                    AND react_actividad_apoyo.id = '7'
                  ...
                  <div style="float:left;width: 100%;outline: white solid thin">
                    ...
                    <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                        ...
                        <tbody>
                          <?php
                          $auxsum = 0;
                          $getrondin = "SELECT react_actividad.id_subdireccion, react_actividad.fecha, react_actividad.folio_expediente, react_actividad.id_sujeto, react_actividad.id_evidencia
                          ...
                          ?>
                            <tr>
                              ...
                              <?php 
                              $n_actividad = 'Elaborar convenios con personas o instituciones públicas y privadas para la protección de sujetos';
                              ?>
                              ...
                              $concatenacion = 'Convenio_Exp_'.$texto_expediente.'_'.$fgetrondin['id_sujeto']; 
                              ?>
