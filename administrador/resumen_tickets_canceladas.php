    ...
    <?php if (isset ($_SESSION ['message'])){?>
      ...
      <div class="wrap">
        ...
        <ul class="tabs">
          ...
          <li><a href="#" class="active" onclick="location.href='resumen_tickets_canceladas.php'"><span class="far fa-address-card"></span><span class="tab-text">INCIDENCIAS CANCELADAS</span></a></li>
