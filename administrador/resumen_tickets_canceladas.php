    ...
    <?php if (isset ($_SESSION ['message'])){?>
      ...
      <div class="wrap">
        ...
        <ul class="tabs">
          ...
          <li><a href="#" class="active" onclick="location.href='resumen_tickets_canceladas.php'"><span class="far fa-address-card"></span><span class="tab-text">CANCELADAS</span></a></li>
                  ...
                  <div>
                    ...
                    <table class="table table-bordered" id="table-tickets">
                        ...
                        <tbody>
                            <?php 
                                $count = 0;
                                $query = "SELECT * FROM tickets WHERE estatus = 'CANCELADA' AND usuario_atencion = 'AZAEL OLIVAR GARCIA'";
                  ...
                  <div>
                    ...
                    <table class="table table-bordered" id="table-tickets">
                        ...
                        <tbody>
                            <?php 
                                $count = 0;
                                $query = "SELECT * FROM tickets WHERE estatus = 'CANCELADA' AND usuario_atencion = 'JONATHAN EDUARDO SANTIAGO JIMÉNEZ'";
                                $result_tickets = mysqli_query($mysqli, $query);
                                while($row = mysqli_fetch_array($result_tickets)) {?>
                                <?php $count = $count + 1 ?>
                                    <tr>
                  ...
                  <div>
                    ...
                    <table class="table table-bordered" id="table-tickets">
                        ...
                        <tbody>
                            <?php 
                                $count = 0;
                                $query = "SELECT * FROM tickets WHERE estatus = 'CANCELADA' AND usuario_atencion = 'GABRIELA PICHARDO GARCÍA'";
                                $result_tickets = mysqli_query($mysqli, $query);
                                while($row = mysqli_fetch_array($result_tickets)) {?>
                                <?php $count = $count + 1 ?>
                                    <tr>
                  ...
                  <div>
                    ...
                    <table class="table table-bordered" id="table-tickets">
                        ...
                        <tbody>
                            <?php 
                                $count = 0;
                                $query = "SELECT * FROM tickets WHERE estatus = 'CANCELADA'";
                                $result_tickets = mysqli_query($mysqli, $query);
                                while($row = mysqli_fetch_array($result_tickets)) {?>
                                <?php $count = $count + 1 ?>
                                    <tr>
