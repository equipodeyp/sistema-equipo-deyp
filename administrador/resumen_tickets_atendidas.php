                  ...
                  <div>
                    ...
                    <table class="table table-bordered" id="table-tickets">
                        ...
                        <tbody>
                            <?php 
                                $count = 0;
                                $query = "SELECT * FROM tickets WHERE estatus = 'ATENDIDA' AND usuario_atencion = 'AZAEL OLIVAR GARCIA'";
                  ...
                  <div>
                    ...
                    <table class="table table-bordered" id="table-tickets">
                        ...
                        <tbody>
                            <?php 
                                $count = 0;
                                $query = "SELECT * FROM tickets WHERE estatus = 'ATENDIDA' AND usuario_atencion = 'JONATHAN EDUARDO SANTIAGO JIMÉNEZ'";
                                $result_tickets = mysqli_query($mysqli, $query);
                                while($row = mysqli_fetch_array($result_tickets)) {?>
                                <?php $count = $count + 1 ?>
                                    <tr>
                  ...
                  <div>
                    ...
                    <table class="table table-bordered" id="table-tickets">
                        ...
                        <tbody>
                            <?php 
                                $count = 0;
                                $query = "SELECT * FROM tickets WHERE estatus = 'ATENDIDA' AND usuario_atencion = 'GABRIELA PICHARDO GARCÍA'";
                                $result_tickets = mysqli_query($mysqli, $query);
                                while($row = mysqli_fetch_array($result_tickets)) {?>
                                <?php $count = $count + 1 ?>
                                    <tr>
                  ...
                  <div>
                    ...
                    <table class="table table-bordered" id="table-tickets">
                        ...
                        <tbody>
                            <?php 
                                $count = 0;
                                $query = "SELECT * FROM tickets WHERE estatus = 'ATENDIDA'";
                                $result_tickets = mysqli_query($mysqli, $query);
                                while($row = mysqli_fetch_array($result_tickets)) {?>
                                <?php $count = $count + 1 ?>
                                    <tr>
