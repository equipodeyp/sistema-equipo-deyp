...
<body>
  <div class="contenedor">
    ...
    <div class="main bg-light">
      ...
      <div class="container">
        <ul class="tabs">
          <li><a class="active"><span class="far fa-address-card"></span><span class="tab-text">DATOS PERSONALES</span></a></li>
...
<script src="../js/controller_menusujeto.js"></script>
<script src="../js/persona.js"></script>
</html>
