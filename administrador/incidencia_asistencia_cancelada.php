          ...
          <article id="tab1">
            ...
            <div class=" well form-horizontal">
              ...
              <ul class="tabs">
                ...
                <li><a href="#" onclick="location.href='./incidencia_asistencia_atendida.php'"><span class="far fa-regular fa-calendar-check"></span><span class="tab-text">INCIDENCIAS <br> ATENDIDAS</span></a></li>
                <li><a href="#" class="active" onclick="location.href='./incidencia_asistencia_cancelada.php'"><span class="far fa-regular fa-copyright"></span><span class="tab-text">INCIDENCIAS <br> CANCELADAS</span></a></li>
              </ul>
              ...
              <?php
              $cl = "SELECT COUNT(*) as t FROM incidencias_asistencias WHERE estatus = 'CANCELADA' AND usuario_atencion = '$m_user'";
              $rcl = $mysqli->query($cl);
              $fcl = $rcl->fetch_assoc();
              // echo $fcl['t'];
              if ($fcl['t'] == 0){
                    echo "<div id='cabecera'>
                      <div class='row alert div-title' role='alert'>
                        <h3 style='text-align:center'>¡ NO HAY INCIDENCIAS CANCELADAS DE ASISTENCIAS MÉDICAS !</h3>
                      </div>
                    </div>";
              } else{
                    echo "
                      <div class='row'>
                        <div id='cabecera'>
                          <div class='row alert div-title'>
                            <h3 style='text-align:center'>INCIDENCIAS DE ASISTENCIAS MÉDICAS CANCELADAS</h3>
                          </div>
                        </div>
                      <div>
...
<tbody>
                                                <?php
                                                    ...
                                                    $query = "SELECT * FROM incidencias_asistencias WHERE usuario_atencion = '$m_user' AND estatus = 'CANCELADA' ORDER BY fecha_hora_atencion ASC";
                                                    ...
                                                    <?php $count = $count + 1 ?>
                                                        <tr>
                                                            ...
                                                            <td style="text-align:center; font-size: 10px; border: 2px solid #97897D;">
                                                                <button style="display: block; margin: 0 auto;" disabled class="btn btn-danger"><?php echo $row['estatus']?></button>
                                                            </td>

                                                            <td style="text-align:center; font-size: 10px; border: 2px solid #97897D;">
                                                                <a href="./detalle_incidencia_cancelada.php?folio_incidencia=<?php echo $row['folio_incidencia']?>" class="btn btn-info">
