<?php
// 1. Inicializar la variable para que no dé el error "Undefined variable"
$data = "";
...
// Esto le dice a PHP: "Desde donde esté este archivo, sube dos niveles y busca mpdf"
require_once __DIR__ . '/../../mpdf/vendor/autoload.php';

// Opcional: Asegura que el reporte se genere en la carpeta del script
chdir(__DIR__);
