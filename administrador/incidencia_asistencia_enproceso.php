        ...
        <div class="secciones">
          <article id="tab1">
            ...
            <div class="secciones form-horizontal sticky breadcrumb flat">
              ...
              <a class="actived" href="./incidencia_asistencia_enproceso.php">INCIDENCIAS EN PROCESO</a>
            </div>
            ...
            <div class=" well form-horizontal">
              ...
              <ul class="tabs">
                <li><a href="#" class="active" onclick="location.href='./incidencia_asistencia_enproceso.php'"><span class="fas fa-regular fa-clock"></span><span class="tab-text">INCIDENCIAS <br> EN PROCESO</span></a></li>
              ...
              <?php
              $cl = "SELECT COUNT(*) as t FROM incidencias_asistencias WHERE estatus = 'EN PROCESO' AND usuario_atencion = '$m_user'";
              $rcl = $mysqli->query($cl);
              $fcl = $rcl->fetch_assoc();
              // echo $fcl['t'];
              if ($fcl['t'] == 0){
                    echo "<div id='cabecera'>
                      <div class='row alert div-title' role='alert'>
                        <h3 style='text-align:center'>¡ NO HAY INCIDENCIAS EN PROCESO DE ASISTENCIAS MÉDICAS !</h3>
                      </div>
                    </div>";
              } else{
                    echo "
                      <div class='row'>
                        <div id='cabecera'>
                          <div class='row alert div-title'>
                            <h3 style='text-align:center'>INCIDENCIAS DE ASISTENCIAS MÉDICAS EN PROCESO</h3>
                          </div>
                        </div>
                      <div>
...
<tbody>
                                                <?php
                                                    ...
                                                    $query = "SELECT * FROM incidencias_asistencias WHERE usuario_atencion = '$m_user' AND estatus = 'EN PROCESO' ORDER BY fecha_hora_solicitud ASC";
