...
<head>
  ...
  <link href="../css/boton_sub.css" rel="stylesheet" type="text/css">
  ...
  <div class="main bg-light">
    <div class="barra">
      ...
      <ul class="tabs">
          ...
          <li><a href="#" class="active" onclick="location.href='sub_expediente.php?folio=<?=$folio_del_expediente?>'"><span class="fa-solid fa-user"></span><span class="tab-text">SUBDIRECCIÓN</span></a></li>
    		...
    		<div class="secciones">
    			<article id="tab1">
					...
					<div class="secciones form-horizontal sticky breadcrumb flat">
								...
								<a class="actived">SUBDIRECCIÓN</a>
					</div>
				</article>
			</div>
		</div>
		...
		<div class="middle">
			...
			<a id="a" href="../administrador/repo_expediente_apoyo.php?folio=<?=$folio_del_expediente?>" class="btn_sub btn1">Subdirección de Apoyo Técnico y Jurídico</a>
			<a id="a" href="../administrador/repo_expediente_analisis.php?folio=<?=$folio_del_expediente?>" class="btn_sub btn1">Subdirección de Análisis de Riesgo</a>
			<a id="a" href="../administrador/repo_expediente_estadistica.php?folio=<?=$folio_del_expediente?>" class="btn_sub btn1">Subdirección de Estadística y Pre-registro</a>
		</div>
...
<a href="detalles_expediente.php?folio=<?=$folio_del_expediente?>" class="btn-flotante">REGRESAR</a>
