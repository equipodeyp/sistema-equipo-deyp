  ...
  <div class="main bg-light">
    <div class="barra">
      ...
      <ul class="tabs">
          ...
          <li><a href="#" class="active" onclick="location.href='../administrador/ver_pdf_analisis.php?folio=<?=$fol_exp?>'"><span class="fa-solid fa-eye"></span><span class="tab-text">VISTA PREVIA</span></a></li>
    		...
    		<div class="secciones">
    			<article id="tab1">
                    ...
                    <div class="secciones form-horizontal sticky breadcrumb flat">
                                ...
                                <a href="../administrador/repo_expediente_analisis.php?folio=<?=$folio_del_expediente?>">ANÁLISIS DE RIESGO</a>
                        ...
                        <form class="container well form-horizontal" method="post" enctype="multipart/form-data">
                            ...
                            <div class="col-md-6 mb-3 ">
                                ...
                                foreach($files as $file){
                                    ...
                                    echo "<iframe style='width:990px; height:600px; border: none;' src='../subdireccion_de_analisis_de_riesgo/repo/$resultado/$resultado/$arg#toolbar=0&navpanes=0&scrollbar=0&embedded=true&navpanes=0' id='iframe_id' onload='disableContextMenu();' onMyLoad='disableContextMenu();'>"; echo "</iframe>";
                                    echo '</div>';
                                    break;
                                    }
                                }
...
<a href="repo_expediente_analisis.php?folio=<?=$folio_del_expediente?>" class="btn-flotante">REGRESAR</a>
