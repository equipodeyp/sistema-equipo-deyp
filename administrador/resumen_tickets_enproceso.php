        ...
        <!DOCTYPE html>
            ...
            <div class="contenedor">
              <div class="sidebar ancho">
                ...
                <div class="user">
                  <?php
                  $sentencia_user=" SELECT usuario, area, apellido_p, apellido_m, sexo FROM usuarios WHERE usuario='$name'";
                ...
                <?php if (isset ($_SESSION ['message'])){?>
                  ...
                  <div class="wrap">
                    ...
                    <ul class="tabs">
                      ...
                      <li><a href="#" class="active" onclick="location.href='resumen_tickets_enproceso.php'"><span class="fas fa-book-open"></span><span class="tab-text">EN PROCESO</span></a></li>
                              ...
                              <div>
                                ...
                                <table class="table table-bordered" id="table-tickets">
                                    ...
                                    <tbody>
                                        <?php 
                                            $count = 0;
                                            $query = "SELECT * FROM tickets WHERE estatus = 'EN PROCESO' AND usuario_atencion = 'AZAEL OLIVAR GARCIA'";
                              ...
                              <div>
                                ...
                                <table class="table table-bordered" id="table-tickets">
                                    ...
                                    <tbody>
                                        <?php 
                                            $count = 0;
                                            $query = "SELECT * FROM tickets WHERE estatus = 'EN PROCESO' AND usuario_atencion = 'JONATHAN EDUARDO SANTIAGO JIMÉNEZ'";
                                            $result_tickets = mysqli_query($mysqli, $query);
                                            while($row = mysqli_fetch_array($result_tickets)) {?>
                                            <?php $count = $count + 1 ?>
                                                <tr>
                              ...
                              <div>
                                ...
                                <table class="table table-bordered" id="table-tickets">
                                    ...
                                    <tbody>
                                        <?php 
                                            $count = 0;
                                            $query = "SELECT * FROM tickets WHERE estatus = 'EN PROCESO' AND usuario_atencion = 'GABRIELA PICHARDO GARCÍA'";
                                            $result_tickets = mysqli_query($mysqli, $query);
                                            while($row = mysqli_fetch_array($result_tickets)) {?>
                                            <?php $count = $count + 1 ?>
                                                <tr>
      ...
      <div class="wrap">
        ...
        <div class="secciones">
          <article id="tab1">
            ...
            <div class="secciones form-horizontal sticky breadcrumb flat">
            <a  href="../administrador/admin.php">REGISTROS</a>
            <a class="actived" href="#">INCIDENCIAS REGISTRADAS</a>
            </div>
          

            <div class=" well form-horizontal">
              <div class="row">
              <!-- menu DIVISOR DE APARTADOS -->
              <ul class="tabs">
                      <li><a href="#" class="active" onclick="location.href='resumen_tickets_enproceso.php'"><span class="fas fa-book-open"></span><span class="tab-text">INCIDENCIAS REGISTRADAS</span></a></li>
                      <!-- <li><a href="#" onclick="location.href='resumen_tickets_atendidas.php'"><span class="far fa-address-card"></span><span class="tab-text">ATENDIDAS</span></a></li>
                      <li><a href="#" onclick="location.href='resumen_tickets_canceladas.php'"><span class="far fa-address-card"></span><span class="tab-text">CANCELADAS</span></a></li> -->
              </ul>
              ...
              <?php
              $cl = "SELECT COUNT(*) as t FROM tickets";
              $rcl = $mysqli->query($cl);
              $fcl = $rcl->fetch_assoc();
              // echo $fcl['t'];
              if ($fcl['t'] == 0){
                    echo "<div id='cabecera'>
                      <div class='row alert div-title' role='alert'>
                        <h3 style='text-align:center'>¡ NO HAY INCIDENCIAS REGISTRADAS!</h3>
                      </div>
                    </div>";
              } else{
                    echo "
                      <div class='row'>
                        <div id='cabecera'>
                          <div class='row alert div-title'>
                            <h3 style='text-align:center'>TABLA DE INCIDENCIAS REGISTRADAS</h3>
                          </div>
                        </div>
                      <div>
                      ...
                      <table class='table table-bordered' id='table-instrumento'>
                        <thead>
                            <tr>
                                ...
                                <th style='text-align:center; font-size: 14px; border: 2px solid #97897D;'>FECHA</th>
...
<tbody>
                                                <?php
                                                    ...
                                                    $query = "SELECT * FROM tickets ORDER BY fecha_solicitud DESC";
                                                ...
                                                ?>
                                                    <?php $count = $count + 1 ?>
                                                        <tr>
                                                            ...
                                                            <td style="text-align:center; font-size: 10px; border: 2px solid #97897D;"> <?php echo $row['folio_reporte']?></td>
                                                            <?php
                                                            ...
                                                            <td style="text-align:center; font-size: 10px; border: 2px solid #97897D;">
                                                                <a style="text-decoration: underline;" href="detalle_respuesta_uno.php?id=<?php echo $row['id']?>" class="btn btn-outline-secondary">
                                                                   Detalle incidencia
                                                                </a>
                                                            </td>
