            ...
            <form class="container well form-horizontal" method="POST" action="guardar_evaluacion_ind.php?folio=<?php echo $identificador; ?>" enctype= "multipart/form-data">
              ...
              <div class="row">
                ...
                <div class="col-md-6 mb-3 validar ">
                  ...
                  <input id="INPUT_FECHA_FIRMA" autocomplete="off" class="form-control" type="date" name="fecha_firma">
                </div>
              ...
              <div id="row_observaciones" class="row">
                ...
                <div class="alert div-title">
                  ...
                  <textarea id="TEXTAREA_OBSERVACIONES" autocomplete="off" name="observaciones" rows="8" cols="238" placeholder="OBSERVACIONES"></textarea>
              </div>
              <div id=row_enter class="row">
                <div>
                    <br>
                    <br>
                    <button style="display: block; margin: 0 auto; text-align:center;" class="btn color-btn-success" id="enter" type="submit">GUARDAR</button>
                </div>
              </div>
            </form>
          </div>
...
<div class="contenedor">
<a href="../administrador/seguimiento_persona.php?folio=<?=$fila_consulta['id']?>" class="btn-flotante">CANCELAR</a>
</div>
</body>
</html>
...
function ocultarCampos() {
  if (selectAnalisisMulti === "" || selectAnalisisMulti === null ){
        ...
        document.getElementById('row_enter').style.display = "none";
      }
}
ocultarCampos();
