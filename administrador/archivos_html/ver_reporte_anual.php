            ...
            <div class="archivador-semanal">
              ...
              <div class="header-controles">
                <div class="año-header">
                  <h2 class="año-header" id="txtAño" style="text-align: center;"><?php echo $anoback; ?></h2>
                </div>
              </div>
              <div class="titulo-semanal">ANUAL</div>
              <div class="cuerpo-reporte">
                <!-- Visor del PDF -->
                <div id="contenedorVisor">
                  <iframe src="../../docs/REPORTES/ANUAL<?php echo $anoback; ?>.pdf" id="visorPDF" class="pdf-visor"></iframe>
                </div>
              </div>
            </div>
          </div>
