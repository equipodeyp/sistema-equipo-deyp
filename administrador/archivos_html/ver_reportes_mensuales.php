          ...
          <div class="container">
            <div class="archivador-anual">
              ...
              <div class="header-anio">
                <h2 class="anio-titulo">2026</h2>
              </div>
              <div class="grid-meses" id="gridMeses">
                <!-- Se generan meses dinámicamente -->
              </div>
            </div>
          </div>
          <!-- Modal de Bootstrap -->
            ...
            <div class="modal-dialog modal-xl modal-dialog-centered">
              <div class="modal-content">
                <div class="modal-header bg-dark text-white">
                  <h5 class="modal-title" id="modalTitle">REPORTE MENSUAL</h5>
                  <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"></button>
                </div>
                <div class="modal-body p-0">
                  <!-- Contenedor del Iframe (Meses pasados) -->
                  <iframe src="" id="pdfFrame" class="pdf-frame d-none"></iframe>
                  <!-- Contenedor de Progreso (Mes actual) -->
                  <div id="progresoMes" class="progress-container d-none">
                    <h2 class="mb-4 text-primary">ESTE MES ESTÁ EN CURSO</h2>
                    <div class="progress w-100" style="height: 40px; border-radius: 20px;">
                      <div id="barAnimate" class="progress-bar progress-bar-striped progress-bar-animated bg-success" role="progressbar" style="width: 0%"></div>
                    </div>
                    <p class="mt-3 text-muted fs-4" id="txtPorcentaje">Calculando avance del mes...</p>
                  </div>
                </div>
              </div>
            </div>
...
<link rel="stylesheet" type="text/css" href="../../css/calendario_mensual.css"/>
<script src="../../js/menu.js"></script>
<script src="../../js/obtenerdatos_meses.js"></script>
</html>
