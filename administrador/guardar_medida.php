...
if ($verifica_medida == 1) {
  ...
  $addmedidas = "INSERT INTO medidas (categoria, tipo, clasificacion, medida, descripcion, date_provisional, date_definitva, modificacion, date_modificada,  estatus, ejecucion, date_ejecucion, folioexpediente, id_persona, fecha_captura)
                 VALUES('$categoria', '$tipo_medida', '$clasificacion_medida', '$medida', '$med_res', '$inicio_medida', '$act_medida', '$medida_mod', '$fecha_mod',  '$estatus', '$municipio_medida', '$date_ejec', '$folio_expediente', '$id_persona', '$fecha')";
...
// validacion del registro correcto
  if($res_validar_medida){
    echo ("<script type='text/javaScript'>
     window.location.href='../administrador/detalles_medidas.php?folio=$id_persona';
