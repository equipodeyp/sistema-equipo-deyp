...
$num_persona = $_SESSION['numpersonas'];
    ...
    <div class="barra">
      ...
      <!--  -->
        <div class="wrap">
            ...
            <li><a href="#" class="active" onclick="location.href='sub_persona.php?folio=<?php echo $fol_exp; ?>'"><span class="fa-solid fa-user"></span><span class="tab-text">SUBDIRECCIÓN</span></a></li>
    		...
    		<div class="secciones">
    			<article id="tab1">
                        ...
                        <div class="secciones form-horizontal sticky breadcrumb flat">
                                    ...
                                    <a href="detalles_expediente.php?folio=<?=$fol_exp?>">EXPEDIENTE</a>
                                    <a href="detalles_persona.php?folio=<?=$num_persona?>">PERSONA</a>
                        ...
                        <div class="container">
                            <div class="middle">
                                ...
                                <a id="a" href="../administrador/repo_persona_apoyo.php?folio=<?=$num_persona?>" class="btn_sub btn1">Subdirección de Apoyo Técnico y Jurídico</a>
                                <a id="a" href="../administrador/repo_persona_analisis.php?folio=<?=$num_persona?>" class="btn_sub btn1">Subdirección de Análisis de Riesgo</a>
                                <a id="a" href="../administrador/repo_persona_estadistica.php?folio=<?=$num_persona?>" class="btn_sub btn1">Subdirección de Estadistica y Pre-registro</a>
                            </div>
                        </div>
    			</article>
    		</div>
...
<a href="detalles_persona.php?folio=<?=$num_persona?>" class="btn-flotante">REGRESAR</a>
