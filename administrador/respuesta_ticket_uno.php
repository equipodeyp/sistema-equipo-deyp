...
// $mail = new PHPMailer(true);
  ...
  if (isset($_POST['update'])) {    
    ...
    //           $mail->addAddress('sippsipped@fiscaliaedomex.gob.mx');              //Name is optional
    ...
    //                     window.location.href='edit_ticket_uno.php?id=$id';
    ...
    //         //   $mail->send();
              echo $verifica;
              echo ("<script type='text/javaScript'>
                        window.location.href='resumen_tickets_enproceso.php';
                        window.alert('!!!!!Registro exitoso¡¡¡¡¡');
                        </script>"); 
            // }   
    }
