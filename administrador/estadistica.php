    ...
    <div class="sidebar ancho">
      ...
      <nav class="menu-nav">
            <ul>
              ...
              <li class="menu-items"><a href="../administrador/bd_react.php"><span class="menu-items" style="color: white; font-weight:bold;"><i class='fa-solid fa-database menu-nav--icon fa-fw'></i> BD REACT</span></a></li>
            </ul>
      </nav>
    </div>
