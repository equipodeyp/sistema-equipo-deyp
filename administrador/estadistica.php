    ...
    <div class="sidebar ancho">
      ...
      <nav class="menu-nav">
            <ul>
              ...
              <li class="menu-items"><a href="../administrador/bd_traslados.php"><span class="menu-items" style="color: white; font-weight:bold;"><i class='fa-solid fa-clipboard-user menu-nav--icon fa-fw'></i> BD TRASLADOS</span></a></li>
              </ul>
      </nav>
    </div>
