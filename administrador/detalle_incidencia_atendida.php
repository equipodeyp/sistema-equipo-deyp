...
$consulta1 = "SELECT* FROM incidencias_asistencias WHERE folio_incidencia = '$folio_incidencia' AND estatus = 'ATENDIDA'";
...
<div class="contenedor">
  ...
  <div class="main bg-light">
    <div class="barra">
      ...
      <div class="wrap">
        <ul class="tabs">
    		<li><a href="#" class="active" onclick="location.href='./detalle_incidencia_atendida.php?folio_incidencia=<?php echo $folio_incidencia; ?>'"><span class="far fa-address-card"></span><span class="tab-text"> DETALLE <br> INCIDENCIA ATENDIDA</span></a></li>
        </ul>
            ...
            <div class="secciones form-horizontal sticky breadcrumb flat">
                ...
                <a href="./incidencia_asistencia_atendida.php">INCIDENCIAS ATENDIDAS</a>
                <a class="actived" href="./detalle_incidencia_atendida.php?folio_incidencia=<?php echo $folio_incidencia; ?>">DETALLE INCIDENCIA ATENDIDA</a>
            </div>
