...
WHERE date_ejecucion BETWEEN '$fechaInicio' AND '$fechaFin' AND clasificacion = 'RESGUARDO'
  ...
  <div class="" id="showafterconsul">
    <div class="container well form-horizontal" style="text-align:center;padding:10px;border:solid 3px; width:98%;border-radius:20px;shadow; float:left;width: 100%;outline: white solid thin">
      ...
      <div class="table-responsive">
        <table id="bd_planeacion_informe_resguardo" class="table table-hover table-striped table-bordered" cellspacing="0" width="100%">
          <thead>
            </h3>
              <tr>
