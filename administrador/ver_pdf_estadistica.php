...
<div class="contenedor">
  <div class="sidebar ancho">
    ...
    <nav class="menu-nav">
           		<ul>
                  <a style='text-align:center' class='user-nombre' href='create_ticket.php?folio=<?php echo $folio_del_expediente; ?>'><button type='button' class='btn btn-light'>INCIDENCIA</button> </a>
            	</ul>
    </nav>
  </div>
  <div class="main bg-light">
    <div class="barra">
      ...
      <ul class="tabs">
          ...
          <!-- <li><a href="#" class="active" onclick="location.href='repo_expediente_estadistica.php?folio=<?=$fol_exp?>'"><span class="fa-solid fa-folder-plus menu-nav--icon fa-fw"></span><span class="tab-text">REPOSITORIO EXPEDIENTE</span></a></li> -->
          <li><a href="#" class="active" onclick="location.href='../administrador/ver_pdf_estadistica.php?folio=<?=$fol_exp?>'"><span class="fa-solid fa-eye"></span><span class="tab-text">VISTA PREVIA</span></a></li>
    		...
    		<div class="secciones">
    			<article id="tab1">
                    ...
                    <div class="secciones form-horizontal sticky breadcrumb flat">
                                ...
                                <a href="../administrador/detalles_expediente.php?folio=<?=$folio_del_expediente?>">EXPEDIENTE</a>
                                <a href="../administrador/sub_expediente.php?folio=<?=$folio_del_expediente?>">SUBDIRECCIÓN</a>
                                <a href="../administrador/repo_expediente_estadistica.php?folio=<?=$folio_del_expediente?>">ESTADÍSTICA Y PRE-REGISTRO</a>
                    ...
                    <div class="container">
                        <form class="container well form-horizontal" method="post" enctype="multipart/form-data">
                            ...
                            <div class="col-md-6 mb-3 ">
                                    ...
                                    <input readonly class="form-control" type="text" value="<?php echo $folio_del_expediente;?>">
                            </div>
                            ...
                            <div class="col-md-6 mb-3 ">
                                ...
                                foreach($files as $file){
                                    ...
                                    echo "<iframe style='width:990px; height:600px; border: none;' src='../subdireccion_de_estadistica_y_preregistro/repo/$resultado/$resultado/$arg#toolbar=0&navpanes=0&scrollbar=0&embedded=true&navpanes=0' id='iframe_id' onload='disableContextMenu();' onMyLoad='disableContextMenu();'>"; echo "</iframe>";
                                    echo '</div>';
                                    break;
                                    }
                                }
...
<a href="repo_expediente_estadistica.php?folio=<?=$folio_del_expediente?>" class="btn-flotante">REGRESAR</a>
