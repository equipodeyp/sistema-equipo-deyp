            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="table-responsive">
                  <table id="bd_rondines" class="table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                    <thead>
                      <tr>
                        ...
                        <th style="text-align:center; color: white; border: 1px solid black; vertical-align: middle;">KILOMETROS</th>
                        <th style="text-align:center; color: white; border: 1px solid black; vertical-align: middle;">ID RONDIN META</th>
                      </tr>
                    </thead>
                    <tbody>
                      <?php
                      include("../../administrador/tablas_estadistica/tabla_rondines_totales.php");
                      ?>
                    </tbody>
                 </table>
                </div>
