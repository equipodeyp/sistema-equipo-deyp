            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="table-responsive">
                  <table id="bd_traslados" class="table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                    <thead>
                        <tr>
                          ...
                          <th style="text-align:center; color: white; border: 1px solid black; vertical-align: middle;">FECHA TRASLADO</th>
                          <th style="text-align:center; color: white; border: 1px solid black; vertical-align: middle;">ID TRASLADO META</th>
                          <th style="text-align:center; color: white; border: 1px solid black; vertical-align: middle;">MUNICIPIO DESTINO</th>
                    ...
                    <tbody>
                      <?php
                      include("../../administrador/tablas_estadistica/tabla_traslados_totales.php");
                      ?>
                    </tbody>
                 </table>
                </div>
