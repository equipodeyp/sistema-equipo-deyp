            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="table-responsive">
                  <table id="bd_sujetos_fuera_del_resguardo" class="table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                    <thead>
                      <tr>
                    ...
                    <tbody>
                      <?php
                      include("../../administrador/tablas_estadistica/tabla_sujetos_fuera_del_resguardo_totales.php");
                      ?>
                    </tbody>
                 </table>
                </div>
