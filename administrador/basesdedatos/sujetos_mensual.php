            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="table-responsive">
                  <table id="bd_sujetos_mensual" class="table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                    <thead>
                        <tr>
                          ...
                          <th style="text-align:center; color: white; border: 1px solid black; vertical-align: middle;">ESTADIA</th>
                        </tr>
                    </thead>
                    <tbody>
                      <?php
