        ...
        <div class="secciones">
          <article id="tab1">
            ...
            <div class="secciones form-horizontal sticky breadcrumb flat">
                ...
                <a class="actived" href="./asistencia _turnada.php">ASISTENCIAS MÉDICAS TURNADAS</a>
            </div>
            ...
            <div class=" well form-horizontal">
              ...
              <ul class="tabs">
                <li><a href="#" class="active" onclick="location.href='./solicitudes _registradas.php'"><span class="fas fa-solid fa-stethoscope"></span><span class="tab-text">ASISTENCIAS MÉDICAS TURNADAS</span></a></li>
...
<tbody>
                                                <?php
                                                    ...
                                                    $query = "SELECT solicitud_asistencia.id_asistencia, solicitud_asistencia.servicio_medico, agendar_asistencia.nombre_institucion, agendar_asistencia.domicilio_institucion, agendar_asistencia.municipio_institucion, agendar_asistencia.fecha_asistencia, agendar_asistencia.hora_asistencia, agendar_asistencia.observaciones, solicitud_asistencia.etapa
