...
$_SESSION['iniciales'] = $id_pers;

$name_folio=$rowfol['folioexpediente'];
$_SESSION['fol_expediente'] = $name_folio;
  ...
  <div class="main bg-light">
    <div class="barra">
      ...
      <ul class="tabs">
          ...
          <li><a href="#" class="active" onclick="location.href='repo_persona_apoyo.php?folio=<?php echo $fol_exp; ?>'"><span class="fa-solid fa-folder-plus menu-nav--icon fa-fw"></span><span class="tab-text">REPOSITORIO PERSONA</span></a></li>
          ...
          <li><a href="#" onclick="location.href='resumen_tickets_canceladas.php'"><span class="far fa-address-card"></span><span class="tab-text">CANCELADAS</span></a></li> -->
    		...
    		<div class="secciones">
              ...
              <div class="secciones form-horizontal sticky breadcrumb flat">
                        ...
                        <a href="detalles_expediente.php?folio=<?=$name_folio?>">EXPEDIENTE</a>
                        <a href="detalles_persona.php?folio=<?=$fol_exp?>">PERSONA</a>
                        <a href="sub_persona.php?folio=<?=$fol_exp;?>">SUBDIRECCIÓN</a>
                        <a class="actived">APOYO TÉCNICO Y JURÍDICO</a>
              </div>

              <div class="container">
              <form class="container well form-horizontal" action="../subdireccion_de_apoyo_tecnico_juridico/cargar_archivo.php?id=<?php echo $id_person; ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="alert div-title">
                  ...
                  <div>
                    ...
                    <table class="table table-bordered" id="table-tickets">
                        ...
                        $path  = "../subdireccion_de_apoyo_tecnico_juridico/repo/$resultado/$id_pers/";
                        ...
                        foreach($files as $file){
                          ...
                          echo "<td style='text-align:center'><a href='ver_pdf_persona_apoyo.php?folio=".$arg."' style='color: #63696D; font-size:18px;'><span class='fa-solid fa-eye'></span></a></td>";
                        //   if ($user=='guillermogv') {
...
<a href="sub_persona.php?folio=<?=$fol_exp;?>" class="btn-flotante">REGRESAR</a>
