          ...
          <article id="tab1">
            ...
            <div class=" well form-horizontal">
              ...
              <ul class="tabs">
                ...
                <li><a href="#" onclick="location.href='./reprogramar_asistencia.php'"><span class="fas fa-regular fa-calendar-week"></span><span class="tab-text">REPROGRAMAR ASISTENCIA MÉDICA</span></a></li>
