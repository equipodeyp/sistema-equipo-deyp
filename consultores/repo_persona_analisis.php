  ...
  <div class="main bg-light">
    <div class="barra">
      ...
      <ul class="tabs">
          ...
          <li><a href="#" class="active" onclick="location.href='repo_persona_analisis.php?folio=<?php echo $fol_exp; ?>'"><span class="fa-solid fa-folder-plus menu-nav--icon fa-fw"></span><span class="tab-text">REPOSITORIO PERSONA</span></a></li>
          ...
          <li><a href="#" onclick="location.href='resumen_tickets_canceladas.php'"><span class="far fa-address-card"></span><span class="tab-text">CANCELADAS</span></a></li> -->
    		...
    		<div class="secciones">
              ...
              <div class="secciones form-horizontal sticky breadcrumb flat">
                        ...
                        <a class="actived">ANÁLISIS DE RIESGO</a>
              </div>
                  ...
                  <div>
                    ...
                    <table class="table table-bordered" id="table-tickets">
                        ...
                        foreach($files as $file){
                          ...
                          echo "<td style='text-align:center'><a href='ver_pdf_persona_analisis.php?folio=".$arg."' style='color: #63696D; font-size:18px;'><span class='fa-solid fa-eye'></span></a></td>";
                        //   if ($user=='guillermogv') {
