...
$consulta = "SELECT usuario, nombre, apellido_p, apellido_m, area FROM usuarios WHERE usuario='$name'";
$answer= $mysqli->query($consulta);
...
<div class="container">
  <div class="row">
    ...
    <h2 style="text-align:center"><?php echo utf8_decode(strtoupper($row['area'])); ?> </span></h2>
  </div>
