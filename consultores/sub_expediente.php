    ...
    <div class="barra">
      ...
      <ul class="tabs">
		...
		<div class="middle">
			...
			<a id="a" href="repo_expediente_apoyo.php?folio=<?=$folio_del_expediente?>" class="btn_sub btn1">Subdirección de Apoyo Técnico y Jurídico</a>
			<a id="a" href="repo_expediente_analisis.php?folio=<?=$folio_del_expediente?>" class="btn_sub btn1">Subdirección de Análisis de Riesgo</a>
			<a id="a" href="repo_expediente_estadistica.php?folio=<?=$folio_del_expediente?>" class="btn_sub btn1">Subdirección de Estadística y Pre-registro</a>
		</div>
