    			...
    			<article id="tab1">
                        ...
                        <div class="container">
                            <div class="middle">
                                ...
                                <a id="a" href="repo_persona_apoyo.php?folio=<?=$fol_exp?>" class="btn_sub btn1">Subdirección de Apoyo Técnico y Jurídico</a>
                                <a id="a" href="repo_persona_analisis.php?folio=<?=$fol_exp?>" class="btn_sub btn1">Subdirección de Análisis de Riesgo</a>
                                <a id="a" href="repo_persona_estadistica.php?folio=<?=$fol_exp?>" class="btn_sub btn1">Subdirección de Estadistica y Pre-registro</a>
                            </div>
                        </div>
    			</article>
    		</div>
...
<a href="detalles_persona.php?folio=<?=$fol_exp?>" class="btn-flotante">REGRESAR</a>
