          ...
          <li><a href="#" onclick="location.href='resumen_tickets_canceladas.php'"><span class="far fa-address-card"></span><span class="tab-text">CANCELADAS</span></a></li> -->
    		...
    		<div class="secciones">
              ...
              <div class="secciones form-horizontal sticky breadcrumb flat">
                        ...
                        <a href="../consultores/sub_expediente.php?folio=<?=$fol_exp?>">SUBDIRECCIÓN</a>
                  ...
                  <div>
                    ...
                    <table class="table table-bordered" id="table-tickets">
                        ...
                        foreach($files as $file){
                          ...
                          echo "<td style='text-align:center'><a href='ver_pdf_apoyo.php?folio=".$arg."' style='color: #63696D; font-size:18px;'><span class='fa-solid fa-eye'></span></a></td>";
                        //   if ($user=='guillermogv') {
