  ...
  <div class="main bg-light">
    <div class="barra">
      ...
      <ul class="tabs">
          ...
          <li><a href="#" class="active" onclick="location.href='ver_pdf_analisis.php?folio=<?=$fol_exp?>'"><span class="fa-solid fa-eye"></span><span class="tab-text">VISTA PREVIA</span></a></li>
    		...
    		<div class="secciones">
    			<article id="tab1">
                    ...
                    <div class="secciones form-horizontal sticky breadcrumb flat">
                                ...
                                <a href="repo_expediente_analisis.php?folio=<?=$folio_del_expediente?>">ANÁLISIS DE RIESGO</a>
