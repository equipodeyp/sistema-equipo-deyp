<?php
	...
	*/
	...
	$aColumnas = array( 'id', 'unidad', 'sede', 'municipio', 'fecha', 'fol_exp' );
	...
	*/
	...
	while ( $aRow = $rResult->fetch_array())
	{
		...
		// $row[] = "<td><a href='modificar.php?id=".$aRow['id']."'><span class='glyphicon glyphicon-folder-open'></span></a></td>";
		$row[] = "<td><a href='modificar.php?id=".$aRow['fol_exp']."'><span class='glyphicon glyphicon-folder-open'></span></a></td>";
