                    ...
                    <!-- <a href="../consultores/registrar_evaluacion.php?folio=<?php echo $identificador; ?>"><button style="display: block; margin: 0 auto;" type="button" id="AGREGAR_CONVENIO" class="btn btn-info">AGREGAR</button></a> -->
                      ...
                      <?php
                        ...
                        $cont_med = $cont_med + 1;
                          ...
                          echo "<td style='text-align:center'>  <a href='../consultores/detalles_convenio_pers.php?id=".$var_fila['id']."'> <button type='button' class='btn color-btn-success'>Detalles</button> </a> </td>";
