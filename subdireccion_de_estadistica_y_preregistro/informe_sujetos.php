      ...
      <nav class="menu-nav">
        <ul>
          ...
          <li id="liestadistica" class="subtitle">
              ...
              <li id="lipersonas" class="menu-items"><a href="../subdireccion_de_estadistica_y_preregistro/total_personas.php">&nbsp;&nbsp;&nbsp;<i class="color-icon fa-solid fa-users menu-nav--icon fa-fw"></i><span class="menu-items" style="color: white; font-weight:bold;"> PERSONAS GENERAL</span></a></li>
                      ...
                      <div class="row">
                              <div class="col-lg-12">
                                  <div class="table-responsive">
                                      ...
                                      <tbody>
                                        <?php
                                        include("../subdireccion_de_estadistica_y_preregistro/tabla_informe_sujetos.php");
                                        ?>
                                      </tbody>
                                     </table>
                                  </div>
