              ...
              <form class="container well form-horizontal" action="detalle_respuesta.php?id=<?php echo $_GET['id']; ?>" method="POST" enctype="multipart/form-data">
                <div class="row">
                  ...
                  <div class="col-md-6 mb-3">
                    ...
                    <input readonly class="form-control" id="" name="usuario" type="text" value="<?php $user;?> ">
                  </div>
...
<a href="../subdireccion_de_estadistica_y_preregistro/tickets.php?folio=<?php echo $folio_expediente; ?>" class="btn-flotante">REGRESAR</a>
