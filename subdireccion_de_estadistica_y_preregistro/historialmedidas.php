...
$fol_exp = $_GET['id'];
$respersona = "SELECT * FROM datospersonales WHERE id = '$fol_exp'";
$rrespersona = $mysqli->query($respersona);
$frespersona = $rrespersona->fetch_assoc();
 ?>
<!DOCTYPE html>
<html lang="es">
<head>
      ...
      <div class="container">
        ...
        <div class="container">
          <div class="secciones form-horizontal sticky breadcrumb flat">
            ...
            <a href="../subdireccion_de_estadistica_y_preregistro/detalles_expediente.php?id=<?=$frespersona['folioexpediente']?>">EXPEDIENTE</a>
            <a href="../subdireccion_de_estadistica_y_preregistro/detalles_persona.php?folio=<?=$fol_exp?>">PERSONA</a>
            <a href="../subdireccion_de_estadistica_y_preregistro/detalles_medidas.php?folio=<?=$fol_exp?>">MEDIDAS</a>
            <a class="actived">HISTORIAL DE MEDIDAS</a>
          </div>
          <div class="row">
            <div class="col-lg-12">
              <div class="table-responsive">
                <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                  <thead>
                  <h3 style="text-align:center">HISTORIAL COMPLETO DE MEDIDAS OTORGADAS A <?php echo $frespersona['identificador']; ?></h3>
                  <tr>
                  ...
                  <tbody>
                    ...
                    $contador = 0;
                          ...
                          WHERE medidas.id_persona ='$fol_exp' AND validar_medida.validar_datos = 'true' AND medidas.estatus != 'EN EJECUCION'
                               ...
                               $fdper = $rdper->fetch_assoc();
                                   ?>
                                       ...
                                       <tr>
                                          ...
                                          <?php include('vermedidadelhistorial.php'); ?>
                                        </tr>
                                   <?php
                                   }
                               ?>
