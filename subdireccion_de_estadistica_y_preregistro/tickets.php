      ...
      <div class="wrap">
        ...
        <ul class="tabs">
          ...
          <div class="secciones form-horizontal sticky breadcrumb flat">
                ...
                <a href="../subdireccion_de_estadistica_y_preregistro/detalles_expediente.php?id=<?php echo $fol_exp; ?>">EXPEDIENTE</a>
...
<a href="../subdireccion_de_estadistica_y_preregistro/create_ticket.php?folio=<?php echo $fol_exp; ?>" class="btn-flotante">REGRESAR</a>
