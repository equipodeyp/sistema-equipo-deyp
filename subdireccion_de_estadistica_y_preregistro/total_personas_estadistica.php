      ...
      <nav class="menu-nav">
        <ul>
          ...
          <li id="liestadistica" class="subtitle">
              ...
              <li id="lipersonas" class="menu-items"><a >&nbsp;&nbsp;&nbsp;<i class="color-icon fa-solid fa-people-line menu-nav--icon fa-fw"></i><span class="menu-items" style="color: white;"> PERSONAS ESTADADISTICA</span></a></li>
