      ...
      <nav class="menu-nav">
        <ul>
          ...
          <li id="liestadistica" class="subtitle">
      			...
      			<ul class="submenu">
              <li id="liexpediente" class="menu-items"><a>&nbsp;&nbsp;&nbsp;<i class='color-icon fa-solid fa-folder-open  menu-nav--icon fa-fw'></i><span class="menu-items" style="color: white;"> EXPEDIENTES</span></a></li>
              ...
              <li id="lipersonas" class="menu-items"><a href="../subdireccion_de_estadistica_y_preregistro/total_personas_estadistica.php">&nbsp;&nbsp;&nbsp;<i class="color-icon fa-solid fa-people-line menu-nav--icon fa-fw"></i><span class="menu-items" style="color: white;"> PERSONAS ESTADADISTICA</span></a></li>
