      ...
      <nav class="menu-nav">
        <ul>
          ...
          <li id="liestadistica" class="subtitle">
      			...
      			<ul class="submenu">
              <li id="liexpediente" class="menu-items"><a >&nbsp;&nbsp;&nbsp;<i class='fa-solid fa-folder-open  menu-nav--icon fa-fw'></i><span class="menu-items" style="color: lime;"> EXPEDIENTES</span></a></li>
