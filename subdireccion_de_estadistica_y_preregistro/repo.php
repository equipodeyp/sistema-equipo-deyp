                ...
                <div class="row">
                  ...
                  <div>
                    ...
                    <table class="table table-bordered" id="table-tickets">
                        ...
                        <tbody>
                        <?php
                        $archivos = scandir("archivos_subidos_estadistica");
                        $num=0;
                        ...
                        <p>  
                            ...
                            <tr>
                              ...
                              <td style="text-align:center"><a title="Descargar Archivo" href="archivos_subidos_estadistica/<?php echo $archivos[$i]; ?>" download="<?php echo $archivos[$i]; ?>" style="color: blue; font-size:18px;"> <span class="glyphicon glyphicon-download-alt" aria-hidden="true"></span> </a></td>
                              <?php
                                  if ($user=='e-adriana') {
                                  echo "<td style='text-align:center'><a title='Eliminar Archivo' href='../subdireccion_de_estadistica_y_preregistro/eliminar_archivo.php?name=archivos_subidos_estadistica/$archivos[$i]' style='color: red; font-size:18px;' onclick='return confirm('Esta seguro de eliminar el archivo?');'> <span class='glyphicon glyphicon-trash' aria-hidden='true'></span> </a></td>";}
                              ?>
                              <!-- <td style="text-align:center"><a title="Eliminar Archivo" href="eliminar_archivo.php?name=archivos_subidos_estadistica/<?php echo $archivos[$i]; ?>" style="color: red; font-size:18px;" onclick="return confirm('Esta seguro de eliminar el archivo?');"> <span class="glyphicon glyphicon-trash" aria-hidden="true"></span> </a></td> -->
                            </tr>
                        <?php }?> 
                        </tbody>
                    </table>
