      ...
      <nav class="menu-nav">
        ...
        <?php
          ...
          <li id="liestadistica" class="subtitle">
              ...
              <li id="lipersonas" class="menu-items"><a href="../subdireccion_de_estadistica_y_preregistro/total_personas.php">&nbsp;&nbsp;&nbsp;<i class="color-icon fa-solid fa-users menu-nav--icon fa-fw"></i><span class="menu-items" style="color: white;"> PERSONAS GENERAL</span></a></li>
              <li id="lipersonas" class="menu-items"><a href="../subdireccion_de_estadistica_y_preregistro/total_personas_estadistica.php">&nbsp;&nbsp;&nbsp;<i class="color-icon fa-solid fa-users menu-nav--icon fa-fw"></i><span class="menu-items" style="color: white;"> PERSONAS ESTADISTICA</span></a></li>
          ...
          <li id="liestadistica3" class="subtitle3">
            ...
            <ul class="submenu3">
              ...
              <li id="limedidas" class="menu-items"><a href="../subdireccion_de_estadistica_y_preregistro/ver_reporte_semestral.php">&nbsp;&nbsp;&nbsp;<i class='color-icon fa-solid fa-calendar menu-nav--icon fa-fw'></i><span class="menu-items" style="color: white;"> SEMESTRAL <br /> </span></a></li>
              <!-- <li id="limedidas" class="menu-items"><a href="../subdireccion_de_estadistica_y_preregistro/total_medidas.php">&nbsp;&nbsp;&nbsp;<i class='color-icon fa-solid fa-person-circle-plus  menu-nav--icon fa-fw'></i><span class="menu-items" style="color: white;"> MEDIDAS</span></a></li> -->
            </ul>
          </li>
          <li>
