...
if ($verifica_update_person == 1) {
  ...
  $datos_validacion = "UPDATE validar_medida SET  1ervalidacion = '$validacion', fecha_1erval = '$fecha_validacion', usuario3 = '$name' WHERE id_medida = '$id_medida'";
  ...
  if($res_validacion){
    echo ("<script type='text/javaScript'>
     window.location.href='../subdireccion_de_apoyo_tecnico_juridico/detalles_medida.php?id=$id_medida';
