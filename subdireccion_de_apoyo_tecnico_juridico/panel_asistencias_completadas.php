            ...
            <div class="row">
                    <div class="col-lg-12">
                        <div class="table-responsive">
                            ...
                            <?php
                                  $cl = "SELECT COUNT(*) as t FROM solicitud_asistencia WHERE solicitud_asistencia.tipo_requerimiento = 'MEDIDAS PROVISIONALES'";
                                  $rcl = $mysqli->query($cl);
                                  $fcl = $rcl->fetch_assoc();
                                  // echo $fcl['t'];
                                  if ($fcl['t'] == 0){
                            ...
                            <tbody>
                              ...
                              <?php
                              $contador = 0;
                              $sentencia1 = "SELECT solicitud_asistencia.id_asistencia, solicitud_asistencia.id_asistencia, 
                              solicitud_asistencia.fecha_solicitud, solicitud_asistencia.id_servidor,
