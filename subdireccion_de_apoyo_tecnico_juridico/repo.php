...
$_SESSION['iniciales_pers'] = $id_pers;
// echo $id_pers;
      ...
      <ul class="tabs">
          ...
          <li><a href="#" onclick="location.href='resumen_tickets_canceladas.php'"><span class="far fa-address-card"></span><span class="tab-text">CANCELADAS</span></a></li> -->
    		...
    		<div class="secciones">
              ...
              <div class="container">
              <form class="container well form-horizontal" action="../subdireccion_de_apoyo_tecnico_juridico/cargar_archivo.php?id=<?php echo $id_pers; ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="alert div-title">
                  ...
                  <div>
                    ...
                    <table class="table table-bordered" id="table-tickets">
                        ...
                        <tbody>
                        <?php
                        $archivos = scandir("../subdireccion_de_apoyo_tecnico_juridico/repo/$resultado/$id_pers/");
                        $num=0;
                        ...
                        foreach($files as $file){
                          ...
                          echo "<td style='text-align:center'><a href='ver_pdf_persona.php?folio=".$arg."' style='color: #63696D; font-size:18px;'><span class='fa-solid fa-eye'></span></a></td>";
                          if ($cargo === 'subdirector' && $area === 'subdireccion de apoyo tecnico y juridico') {
                            echo "<td style='text-align:center'><a title='Descargar Archivo' href='../subdireccion_de_apoyo_tecnico_juridico/repo/".$resultado."/".$id_pers."/".$arg."' download='$arg' style='color: #97897D; font-size:18px;'> <span class='glyphicon glyphicon-download-alt' aria-hidden='true'></span> </a>"; echo "</td>";
                            echo "<td style='text-align:center'><a title='Eliminar Archivo' href='../subdireccion_de_apoyo_tecnico_juridico/eliminar_archivo.php?name=repo/".$resultado."/".$id_pers."/".$arg."' style='color: #A19E9F; font-size:18px;' onclick='return confirm('Esta seguro de eliminar el archivo?');'> <span class='glyphicon glyphicon-trash' aria-hidden='true'></span> </a>"; echo "</td>";
                          }
                          echo '</tr>';
                        }
                        ?>
...
<a href="../subdireccion_de_apoyo_tecnico_juridico/detalles_persona.php?folio=<?=$fol_exp?>" class="btn-flotante">REGRESAR</a>
