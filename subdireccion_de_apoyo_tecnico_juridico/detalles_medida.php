      ...
      <form class="container well form-horizontal" method="POST" action="actualizar_medida.php?folio=<?php echo $id_medida; ?>" enctype= "multipart/form-data">
        ...
        <div class="row">
          ...
          <div class="col-md-6 mb-3 validar">
            ...
            <select class="form-select form-select-lg" id="CATEAGORIA_MEDIDA" name="CATEAGORIA_MEDIDA" disabled>
              <!-- <option disabled selected value>SELECCIONE UNA OPCIÓN</option> -->
              <option disabled selected value="INICIAL">INICIAL</option>
          ...
          <div class="col-md-6 mb-3 validar">
            ...
            <select class="form-select form-select-lg" id="TIPO_DE_MEDIDA" name="TIPO_DE_MEDIDA" disabled>
              <!-- <option disabled selected value>SELECCIONE EL TIPO DE MEDIDA</option> -->
              <option disabled selected value="PROVISIONAL">PROVISIONAL</option>
