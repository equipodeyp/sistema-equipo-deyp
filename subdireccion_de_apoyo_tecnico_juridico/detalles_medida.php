  ...
  <div class="main bg-light">
    ...
    <div class="container">
        <div class="secciones form-horizontal sticky breadcrumb flat">
          ...
          <a href="../subdireccion_de_apoyo_tecnico_juridico/modificar.php?id=<?=$rowfol['folioexpediente']?>">EXPEDIENTE</a>
          ...
          <?php
            if ($rowmedida['estatus'] == 'EN EJECUCION') {
              echo '<div class="col-md-6 mb-3 validar">
                ...
                <select class="form-select form-select-lg" id="TIPO_DE_MEDIDA" name="TIPO_DE_MEDIDA" required="" onChange="act_datedef(this)" disabled>
            ...
            <?php
              if ($rowmedida['estatus'] == 'EN EJECUCION') {
                echo '<div class="col-md-6 mb-3 validar">
                  ...
                  <select class="form-select form-select-lg" id="ESTATUS_MEDIDA"  name="ESTATUS_MEDIDA" onchange="actualizar_estatus_medida(this)" disabled>
              ...
              $validacion13 = $fil_val13['validacion'];
                // if ($validacion13 != 'true') {
                  echo '
                    ...
                    <textarea name="COMENTARIO" id="COMENTARIO" rows="8" cols="80" placeholder="Escribe tus comentarios" maxlength="100" disabled></textarea>
...
<div class="contenedor">
  ...
  $fil_val = $res_val->fetch_assoc();
   ...
   ?>
<a href="../subdireccion_de_apoyo_tecnico_juridico/detalles_medidas.php?folio=<?=$id_p?>" class="btn-flotante">REGRESAR</a>
</div>
<!-- SCRIPT DE FECHAS  -->
